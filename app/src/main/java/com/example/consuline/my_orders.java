...
import java.util.Map;
    ...
    private void getData() {
        ...
        String url = "http:///localhostORipadress/temp/myorders.php";
                ...
                try {
                    ...
                    for(int i = 0 ; i<result.length();i++) {
                        ...
                        for(int j=0;j<items.length();j++){
                            ...
                            int price = Integer.parseInt(item.getString(1).substring(0,item.getString(1).indexOf('k')).trim());
                        ...
                        o.setTotal(Integer.toString(total)+"k");
                        models.add(o);
                    }
